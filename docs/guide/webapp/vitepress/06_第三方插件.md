...
（1）添加视频列表组件XgplayerList

```vue [.vitepress/theme/components/XgplayerList.vue]
<template>
...
```vue
<XgplayerList :videos="[
  { url: 'http://vjs.zencdn.net/v/oceans.mp4', title: '海洋' },
  { url: 'https://media.w3.org/2010/05/sintel/trailer.mp4', title: '科幻短片' }
]" />
```
